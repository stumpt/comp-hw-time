...
#insert u2 = 0
modu = np.insert(u, 1, [u1], axis=0)
#print(modu)

#conver to floats for easier manipulation
uFinal = modu.astype(float)
...
#this code unsplits element 1 from element 2 as they share the axial stress.
modStress = np.insert(stress, 1, (stress[0]/2), axis=0)
modStress[0] = modStress[1]
