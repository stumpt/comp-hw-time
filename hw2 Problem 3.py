...
#concentrated/unknown loads in lbf - None indicates unknown
P1 = 0
P2 = 0
P3 = None
...
def check_Symmetric(array):
    ...
    if array.shape == transposed.shape:
        if (array == transposed).all():
            ...
            print ("\nError Code 1: The matrix is not symmetric. \n")
    else:
        print ("\nError 2: The matrix is not symmetric. \n")
...
print("Since element 3 sees a tensile force stretching the spring, we can see the force applied\nat node 3 is in the positive x direction.")
print("Thus, the required force P is equal to 4 lbf.\n")
